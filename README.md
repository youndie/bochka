...
[![s3-tests](https://img.shields.io/badge/ceph%2Fs3--tests-149%2F746-yellow)](ci/s3-tests.sh)
...
> **149 of 746 passed (19%)** — `ceph/s3-tests` at `5522d1c`, 2m58s, `./ci/s3-tests.sh`.

Low, and it should be: there is no multipart upload yet, and most of the suite exercises
